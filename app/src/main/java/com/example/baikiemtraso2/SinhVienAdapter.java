...
public class SinhVienAdapter extends FirebaseRecyclerAdapter<SinhVien, SinhVienAdapter.myViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull SinhVien model) {
